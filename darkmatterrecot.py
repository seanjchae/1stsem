...
for j in range(len(t1)):
	mt=172.76
	G=10
	chichi.append((((t1[j]-mt)/G)**2)+((t2[j]-mt)/G)**2)

plt.hist(chichi,range=(0,100),bins=100,histtype='step',linewidth=2,color='blue')
plt.xlabel('$\chi$$^{2}$')
plt.show()
...
#plt.xlim(0,500)
#plt.hist(out,range=(0,500),bins=100,histtype='stepfilled',color='blue',label = r'$t\bar{t}$')
#plt.hist(out,range=(0,500),bins=100,histtype='step',linewidth=2,color='black')
#plt.xlabel('M$_{jjj}$ [GeV]')
